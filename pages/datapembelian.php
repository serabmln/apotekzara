      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
        	<table class="tabel-profil">
        		...
        		<tr>
        			<th>Supplier</th>
        			<td id="nm_supplierdetail"></td>
                    <th>Status</th>
                    <td id="status_pembeliandetail"></td>
        		</tr>
        	</table>
			<table class="table table-striped">
				...
				<tfoot>
					...
					<tr>
						<th colspan="4" class="text-right">Total PPN :</th>
						<th class="text-right">
							<span id="total_pembeliandetail"></span>
						</th>
					</tr>
    ...
    success: function(data) {
        ...
        $.each(objData, function(key, val) {
            const baris_baru = `
                <tr>
                    <td>${val.nm_obat}</td>
                    <td class="text-right">${val.hrg_beli}</td>
                    <td class="text-center">${val.jml_beli}</td>
                    <td>${val.sat_beli}</td>
                    <td>${val.ppn_type}</td>
                    <td>${val.ppn_total}</td>
            ...
            total_pembelian += Number(val.subtotal);
