    ...
    <div class="kotak-data-tab">
    	<ul class="nav nav-pills" id="pills-tab" role="tablist">
    	  <?php 
    	   ...
    	   ?>
          <li class="nav-item">
            <a class="nav-link active" id="tigapuluh_hari-tab" data-toggle="pill" href="#tigapuluh_hari" role="tab" aria-controls="tigapuluh_hari" aria-selected="true">Kurang Dari 5 Bulan <sup>( <?php echo $jml_30; ?> )</sup></a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="sepuluh_hari-tab" data-toggle="pill" href="#sepuluh_hari" role="tab" aria-controls="sepuluh_hari" aria-selected="false">Kurang Dari 3 Bulan <sup>( <?php echo $jml_10; ?> )</sup></a>
          </li>
          <li class="nav-item">
