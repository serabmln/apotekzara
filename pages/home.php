	...
	<div class="konten-home" style="margin-top: 25px;">
		<div class="row" style="margin-bottom: 18px;">
			...
			<div class="col-lg-4">
				<?php 
					$tgl_ini = date('Y-m-d');
					$query_profit = "SELECT SUM(profit_obat) AS total FROM tbl_penjualandetail left join tbl_penjualan on tbl_penjualan.no_penjualan = tbl_penjualandetail.no_penjualan where tbl_penjualan.tgl_penjualan = '$tgl_ini'";
					$sql_tprofit = mysqli_query($conn, $query_profit) or die ($conn->error);
					$dprofit = mysqli_fetch_array($sql_tprofit);
					$tprofit = $dprofit['total'];
				 ?>
				<div class="card text-white" style="background-color: #877652;">
			      <div class="card-body" style="padding: 10px 20px;">
			        <h6 class="card-title">Total Profit Hari ini</h6>
			        <div class="card-text" align="right" style="font-size: 34px; font-weight: lighter;">
			        	Rp<?php echo number_format($tprofit); ?>
			        </div>
			        <!-- <a href="#" class="btn btn-primary">Go somewhere</a> -->
			      </div>
			    </div>
		...
		<div class="row" style="margin-bottom: 18px;">
			<div class="col-lg-4">
				<?php 
					$query_30 = "SELECT * FROM tbl_dataobat INNER JOIN tbl_stokexpobat ON tbl_dataobat.kd_obat = tbl_stokexpobat.kd_obat WHERE tbl_stokexpobat.tgl_exp > CURDATE() AND tbl_stokexpobat.tgl_exp <= DATE_ADD(CURDATE(), INTERVAL 5 MONTH) AND tbl_stokexpobat.stok > 0;";
				...
				<div class="card text-white" style="background-color: #5a8752;">
			      <div class="card-body" style="padding: 10px 20px;">
			        <h6 class="card-title">Jml Produk kadaluarsa < 5 Bulan</h6>
			        <div class="card-text" align="right" style="font-size: 34px; font-weight: lighter;">
			        <?php echo $jml_30; ?>
			        </div>
			        <!-- <a href="#" class="btn btn-primary">Go somewhere</a> -->
			...
			<div class="col-lg-4">
				<?php 
					$query_10 = "SELECT * FROM tbl_dataobat INNER JOIN tbl_stokexpobat ON tbl_dataobat.kd_obat = tbl_stokexpobat.kd_obat WHERE tbl_stokexpobat.tgl_exp > CURDATE() AND tbl_stokexpobat.tgl_exp <= DATE_ADD(CURDATE(), INTERVAL 3 MONTH) AND tbl_stokexpobat.stok > 0;";
				...
				<div class="card text-white" style="background-color: #8c5731;">
			      <div class="card-body" style="padding: 10px 20px;">
			        <h6 class="card-title">Jml Produk kadaluarsa < 3 Bulan</h6>
			        <div class="card-text" align="right" style="font-size: 34px; font-weight: lighter;">
			        	<?php echo $jml_10; ?>
			        </div>
			        <!-- <a href="#" class="btn btn-primary">Go somewhere</a> -->
