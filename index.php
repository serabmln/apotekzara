...
<html lang="en">
  <head>
    ...
    <title>
      Aplikasi Forecasting Apotek Zara | 
      <?php 
        if(@$_GET['page']=='') {
          echo "Dashboard";
  ...
  <body class="bg-light">
  	<!-- <div class="logo bg-info">
  		<span class="navbar-brand logo-atas text-white" href="#">Aplikasi Sales Forecasting - Apotek Zara</span>
  	</div> -->
  	<div id="container">
  	<div id="main">
  	<div class="col-md-12 bg-info p-1 title">
  		...
  		<div class="row">
  			<div class="col-md-6">
  				<span class="text-white font-weight-light">Aplikasi Sale Forecasting - Apotek Zara</span>
  			</div>
      ...
      <script src="asset/ChartJs/Chart.min.js"></script>
  		...
  		<div class="col-md-10 content">
            ...
            } else if(@$_GET['page']=='info_stock_obat') {
              include 'pages/info_stock_obat.php';
  	...
  	<footer>
  		<i class="fas fa-copyright"></i> Apotek Zara - 2024
  	</footer>
    <!-- Optional JavaScript -->
